const colors = {
  primary: "#1A2214", // Extremely dark forest (softer than pure black)
  secondary: "#293F16", // Deep Forest (Anchor color)
  secondary2: "#3D5A2A", // Sophisticated Moss
  secondary3: "#527A37", // Deep Leaf Green
